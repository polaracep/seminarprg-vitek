...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            BankAccount account1 = new BankAccount("Streichbruder", "EUR" );
            BankAccount account2 = new BankAccount("Sigmaboy", "EUR" );
            Console.WriteLine("Vlastník účtu " + account1.holderName + "\nčíslo účtu: " + account1.accountNumber  + "\nzústatek: " + account1.balance + account1.currency);
